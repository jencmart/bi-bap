...
% matematické balíčky - ty cou pouziva Ing. Kalvoda, Ph.D.
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsthm}
\usepackage{mathrsfs}
...
% **** PSEUDOCODE ****
\usepackage{amsfonts}
% \usepackage{algorithm,algpseudocode} % tento balicek se bije s tim co je o radek dal
% title numbered && ruled ; lines numbered
...
% \include{chapters/02_lts} -- everything in first chapter
