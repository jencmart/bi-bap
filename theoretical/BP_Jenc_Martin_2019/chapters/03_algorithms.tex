...
The matrix $\vec{\overline{R}}$  can be updated to $\vec{R}^{(+)}$  without the presence of matrix $\vec{Q}$. We use this observation  in the algorithm described in \ref{sectionbanb}.
\end{note}
...
\section{BAB algorithm} \label{sectionbanb}  % Also from Agulló, 2000
