...
setup(
    ...
    long_description='',
    ext_modules=ext_modules,  # ext_modules to install
    install_requires=['cppimport', 'numpy', 'pandas', 'pybind11>=2.2', 'scipy', 'scikit-learn'],
    cmdclass={'build_ext': BuildExt},  # build class for building ext_modules
    zip_safe=False,
)
